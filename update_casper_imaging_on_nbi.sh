...
#	This script was written to automatically update the version of the Casper Imaging application 
#	on any NetBoot image where an older version of the application is found (OS X only). This 
#	script can be run from the JSS against all NetBoot servers provided an updated version of the
#	Casper Imaging application has previously been installed in the Applications folder. NetBoot
#	images without a previous version of Casper Imaging will not be affected. 
